...
export function findCraftIdFromItem (itemName: any) {

    itemName = itemName.toUpperCase();
    
    return (CRAFTS as any)[itemName];
}

export function findCraftByItemId(id: number) {
	let itemName: any = null;
	
	for (const item of serverConfig.items) {
		if((ItemIds as any)[item.name.toUpperCase()] === id) {
